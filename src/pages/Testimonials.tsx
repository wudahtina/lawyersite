        ...
        <div className="container mx-auto px-4 max-w-3xl">
          ...
          <div className="bg-white p-8 shadow-lg rounded-lg border-t-4 border-law-gold">
            <blockquote className="text-xl text-gray-600 italic mb-6">
              "Your trust is our most valuable asset. At the Law Office of Christian Anthony White, we're committed to upholding the highest ethical standards and delivering exceptional results for every client we serve."
            </blockquote>
            <div className="flex items-center">
              ...
              />
              <div>
                <h4 className="font-serif font-bold text-xl">Christian Anthony White</h4>
